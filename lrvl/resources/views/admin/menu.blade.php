    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('admin.test2')?'active':'' }}" href="{{ route('admin.addNews') }}">Редактор новостей</a>
                </li>
                <li class="nav-item">
...
{{--        <a class="p-2 text-dark" href="{{ route('admin.test1') }}">Личный кабинет</a>--}}
{{--        <a class="p-2 text-dark" href="{{ route('admin.test2') }}">Редактор новостей</a>--}}
{{--    </nav>--}}
